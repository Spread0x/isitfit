...
def display_footer():
    ...
    logger.info("ℹ️  For more info about isitfit, check https://isitfit.autofitcloud.com")
    logger.info("🌎 Consider following the Global Climate Strike news at https://twitter.com/hashtag/ClimateStrike")
    logger.info("❤️  Built by AutofitCloud Technologies, Inc.  https://www.autofitcloud.com")
